...
class SkinEditView extends UIelement {
  ...
  @Override
    ...
    strokeWeight(5);
    while (a<areas.size()) {
      areas.get(a).location.render(0, UIcolors[I_FOREGROUND]);
      pushMatrix();
