...
public class Test2 extends PApplet {
  ...
  public void setup() {
    ...
    AutoFaderW fade=new AutoFaderW(ac, 2);
    ...
    //    fade.addInput(inputgain);
    //    ac.out.addInput(fade);
    ...
    //    b[0]=new Knob("b1", "Pre").attach(ac, fade, fade.setPreCount, 0, 1000, 10, 10, false);
    //    b[1]=new Knob("b2", "Post").attach(ac, fade, fade.setPostCount, 0, 1000, 10, 10, false);
    ...
    //comp.sideChain.addPoint((double)500 * 6 / 7, 2);
    comp.sideChain.setLoopStart(0);
    comp.sideChain.setLoopEnd((float)1000 * 6 / 7);
    //    fade.gain.setLoop(true);
    //    fade.gain.setLoopStart(0);
    //    fade.gain.addPoint((float)2000* 6 / 7, 0);
    //    fade.gain.setLoopEnd((float)4000 * 6 / 7);
    //
