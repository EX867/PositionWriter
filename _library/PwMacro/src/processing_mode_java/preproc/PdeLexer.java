...
public class PdeLexer extends antlr.CharScanner implements PdeTokenTypes, TokenStream {
  ...
  public Token nextToken() throws TokenStreamException {
    ...
    for (; ; ) {
      ...
      resetText();
      int _begin=text.length();//if invalid token exists.
      try {   // for char stream error handling
        try {   // for lexical error handling
          switch (LA(1)) {
            ...
            case '\'':// cause massive error output(?)
            {
              mCHAR_LITERAL(true);
              theRetToken=_returnToken;
              break;
            }
            case '"': // cause infinite loop
            {
            ...
            default:
              if ((LA(1) == '>') && (LA(2) == '>') && (LA(3) == '>') && (LA(4) == '=')) {
                ...
                mSL_COMMENT(true);
                theRetToken=_returnToken;
              } else if ((LA(1) == '/') && (LA(2) == '*')) {// comment start (cause infinite loop)
                mML_COMMENT(true);
                theRetToken=_returnToken;
              } else if ((LA(1) == '=') && (LA(2) == '=')) {
                mEQUAL(true);
          ...
          try {
            match(LA(1)); // eat it.
          }catch(MismatchedCharException me){ // will not happened!!
          }
      ...
      } catch (TokenStreamRecognitionException e) {//treat bad characters/bad segments as tokens!
        if (_token == null) {
          _token=makeToken(BAD_TOKEN);
  ...
  public final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
    ...
    match("/*");
    {
      _loop359:
      do {
        if (LA(1) == 0xFFFF) {// stream end! ignore it.
          break;
        } else if ((LA(1) == '\r') && (LA(2) == '\n') && ((LA(3) >= '\u0003' && LA(3) <= '\uffff')) && ((LA(4) >= '\u0003' && LA(4) <= '\uffff'))) {
          match('\r');
          match('\n');
