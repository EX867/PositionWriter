...
//    return pkg.startsWith("processing.xml.");
  ...
  private String debugHiddenAfter(AST ast) {
    return (ast instanceof CommonASTWithHiddenTokens) ?
      debugHiddenTokens(((CommonASTWithHiddenTokens) ast).getHiddenAfter()) : "";
  }
  ...
  private String debugHiddenBefore(AST ast) {
    ...
    CommonHiddenStreamToken parent =
      ((CommonASTWithHiddenTokens) ast).getHiddenBefore();
