...
public class TextTransform {
  ...
  public TextTransform add(Edit edit) {
    edits.add(edit);
    built = false;
    return this;
  }
  ...
  public TextTransform addAll(Collection<Edit> edits) {
  ...
  public static class Edit {
    ...
    public Edit(int fromOffset, int fromLength, int toOffset, int toLength, String text) {
